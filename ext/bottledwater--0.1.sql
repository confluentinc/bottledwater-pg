...
CREATE OR REPLACE FUNCTION bottledwater_table_schema(name) RETURNS text
    AS 'bottledwater', 'bottledwater_table_schema' LANGUAGE C VOLATILE STRICT;
...
CREATE OR REPLACE FUNCTION bottledwater_export(text) RETURNS setof bytea
